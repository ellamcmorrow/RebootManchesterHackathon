...
import { FaEnvelope, FaUser, FaSearch, FaCreditCard, FaHome, FaMoneyCheck } from "react-icons/fa";
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <div className="p-4 flex-grow">
        <h2 className="text-lg font-semibold text-gray-800">Current accounts</h2>
